...
enum custom_keycodes {
 ...
 const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_ALPHA] = KEYMAP( /* Base */
      KC_Q, KC_W, KC_E, KC_R, KC_T, KC_NO, KC_NO, KC_NO, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_NO,
      KC_A, LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_NO, KC_NO, KC_NO, KC_H, LSFT_T(KC_J), LCTL_T(KC_K), LALT_T(KC_L), KC_SCOLON, KC_NO,
